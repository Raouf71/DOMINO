...
void Tree::addChild(TreeNode* parent, int childData) {
...
//     first_ray.addKey(my_uav->coordToKey(octomap::point3d(0, 0, 0)));     // add empty key to match size of rays


//     // for (size_t i = 0; i < 8; i++)  // 8 rays
//     // {
//     //     for (size_t j = 0; i < 3; i++)
//     //     {
//     //         // check whether key is empty, i.e. (0,0,0)
//     //         // if (!key.full())

//     //         octomap::OcTreeNode* arena_node = my_map->search(first_ray);
...
//     // iterate through every ray: MODULO 3
